  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <div className="md:col-span-2 space-y-3">
        ...
        <p className="text-sm text-blue-600 dark:text-blue-400">{book.category}</p>
      ...
      <Modal open={open} title="Delete book" onClose={()=>setOpen(false)} onConfirm={onDelete} confirmText="Delete">
